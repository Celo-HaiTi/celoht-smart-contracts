...
contract CeloHTServicePayments is ICeloHTServicePayments, AccessControl {
    ...
    function payForService(
        ...
        ICeloHTAgentRegistry.Agent memory agent = agentRegistry.getAgent(
            agentId
        );
        ...
        _transferExact(msg.sender, treasury, treasuryShare);
    ...
    function getPayment(
        ...
        if (payment.customer == address(0)) revert PaymentNotFound(paymentId);
        return payment;
    }
